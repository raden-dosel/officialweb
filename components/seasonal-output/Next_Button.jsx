...
const HoverNextButton = ({ 
  ...
  return (
    <div 
      className={`group fixed top-0 right-0 h-full ${buttonWidth} flex items-center justify-center ${className}
    ...
    >
      ...
      >
        ...
        <div className="relative p-2 rounded-full group-active:scale-95 transition-transform">
          <div className="absolute inset-0 bg-gradient-to-r from-pink-600 to-purple-500 
        ...
        <div className="absolute right-full top-1/2 -translate-y-1/2 h-1 w-0 
                      bg-gradient-to-r from-transparent to-pink-500
                      opacity-0 group-hover:w-8 group-hover:opacity-50
                      transition-all duration-300 delay-75" />
      </button>

      {/* Progressive indicator line */}
      <div className="absolute inset-y-0 left-0 w-0.5 bg-gradient-to-b 
...
export default HoverNextButton;